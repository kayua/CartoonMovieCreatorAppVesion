...
public class RecognizeFragment extends Fragment {
    ...
    public void doInference(float[][][][] input) throws IOException {
        ...
        nomes.add("Aedes Med.");
        nomes.add("Aedes Sie.");
        nomes.add("Anopheles Alb.");
        nomes.add("Anopheles Don.");
        nomes.add("Anopheles Ruf.");
        nomes.add("Anopheles Atr.");
        nomes.add("Anopheles Dir.");
        nomes.add("Anopheles Far.");
        nomes.add("Anopheles Fre.");
        nomes.add("Anopheles Gam.");
        nomes.add("Anopheles G. A.");
        nomes.add("Anopheles G. K.");
        nomes.add("Anopheles G. R");
        nomes.add("Anopheles Mer.");
        nomes.add("Anopheles Min.");
        nomes.add("Anopheles Qua");
        nomes.add("Anopheles Ste.");
        nomes.add("Culex Qui.");
        nomes.add("Culex Pip.");
        nomes.add("Culex Tar.");
        nomes.add("Culiceta Inc.");
