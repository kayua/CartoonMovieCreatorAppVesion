...
public class BrushDrawingStateListener implements BrushViewChangeListener {
    ...
    public void onViewAdd(DrawingView drawingView) {
        ...
        if (mOnPhotoEditorListener != null) {
            ...
            mOnPhotoEditorListener.onAddViewListener(ViewType.BRUSH_DRAWING,
    ...
    public void onViewRemoved(DrawingView drawingView) {
        ...
        if (mViewState.getAddedViewsCount() > 0) {
            ...
            View removeView = mViewState.removeAddedView(mViewState.getAddedViewsCount() - 1);

            if (!(removeView instanceof DrawingView)) { mPhotoEditorView.removeView(removeView); }
        ...
        if (mOnPhotoEditorListener != null) {
            ...
            mOnPhotoEditorListener.onRemoveViewListener(
                    ViewType.BRUSH_DRAWING, mViewState.getAddedViewsCount()
            );
        }
    }
