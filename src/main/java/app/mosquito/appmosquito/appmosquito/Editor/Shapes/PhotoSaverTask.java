...
class PhotoSaverTask extends AsyncTask<String, String, PhotoSaverTask.SaveResult> {
    ...
    private void handleFileCallback(SaveResult saveResult) {
        ...
        if (exception == null) {
            ...
            if (mSaveSettings.isClearViewsEnabled()) { mBoxHelper.clearAllViews(mDrawingView); }
    ...
    public void saveBitmap() { execute(); }

    public void saveFile(String imagePath) { execute(imagePath); }
