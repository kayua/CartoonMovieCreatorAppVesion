...
public interface OnPhotoEditorListener {
     ...
     * @see ja.burhanrashid52.photoeditor.ViewType
     */
    void onAddViewListener(ja.burhanrashid52.photoeditor.ViewType viewType, int numberOfAddedViews);
     ...
     * @param numberOfAddedViews number of views currently added
     */
    void onRemoveViewListener(ja.burhanrashid52.photoeditor.ViewType viewType, int numberOfAddedViews);

    /**
     * A callback when user start dragging a view which can be
     * any of {@link ja.burhanrashid52.photoeditor.ViewType}
     *
     * @param viewType enum which define type of view is added
     */
    void onStartViewChangeListener(ja.burhanrashid52.photoeditor.ViewType viewType);
     ...
     * @param viewType enum which define type of view is added
     */
    void onStopViewChangeListener(ja.burhanrashid52.photoeditor.ViewType viewType);
}
