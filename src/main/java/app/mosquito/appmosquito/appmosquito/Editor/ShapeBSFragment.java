...
public class ShapeBSFragment extends BottomSheetDialogFragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public void setPropertiesChangeListener(Properties properties) { mProperties = properties; }
    ...
    public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
        ...
        switch (seekBar.getId()) {
            ...
            case R.id.shapeOpacity:
                ...
                if (mProperties != null) { mProperties.onOpacityChanged(i); }
                break;

            case R.id.shapeSize:

                if (mProperties != null) { mProperties.onShapeSizeChanged(i); }
                break;
