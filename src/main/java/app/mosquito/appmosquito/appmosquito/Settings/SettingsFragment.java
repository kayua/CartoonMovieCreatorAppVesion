...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if(switchLowPower.equals("on")){
            ...
            lowPower.setChecked(true); }else{ lowPower.setChecked(false); }
        ...
        if(switchGeoPrecision.equals("on")){
            ...
            geoPrecision.setChecked(true); }else{ geoPrecision.setChecked(false); }
        ...
        if(switchAutoStart.equals("on")){
            ...
            autoStart.setChecked(true); }else{ autoStart.setChecked(false); }
        ...
        if(switchEmailNotification.equals("on")){
            ...
            emailNotification.setChecked(true); }else{ emailNotification.setChecked(false); }
        ...
        if(switchRealTimeNotification.equals("on")){
            ...
            realTimeNotification.setChecked(true); }else{ realTimeNotification.setChecked(false); }
        ...
        if(switchInfectionNotification.equals("on")){
            ...
            infectionNotification.setChecked(true);}else{infectionNotification.setChecked(false); }
        ...
        if(switchSoundNotification.equals("on")){
            ...
            soundNotification.setChecked(true); }else{ soundNotification.setChecked(false); }
        ...
        if(switchAdvancedFilters.equals("on")){
            ...
            advancedFilters.setChecked(true); }else{ advancedFilters.setChecked(false); }
        ...
        if(switchRotation.equals("on")){
            ...
            rotation.setChecked(true); }else{ rotation.setChecked(false); }
        ...
        if(switchHumidity.equals("on")){
            ...
            humidity.setChecked(true); }else{ humidity.setChecked(false); }
        ...
        if(switchPressure.equals("on")){
            ...
            pressure.setChecked(true); }else{ pressure.setChecked(false); }
        ...
        if(switchLuminosity.equals("on")){
            ...
            luminosity.setChecked(true); }else{ luminosity.setChecked(false); }
        ...
        if(switchTemperature.equals("on")){
            ...
            temperature.setChecked(true); }else{ temperature.setChecked(false); }
        ...
        if(switchDayActivity.equals("on")){
            ...
            dayActivity.setChecked(true); }else{ dayActivity.setChecked(false); }
        ...
        if(switchDayActivity.equals("on")){
            ...
            nightActivity.setChecked(true); }else{ nightActivity.setChecked(false); }

        lowPower.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if(lowPower.isChecked()){ editor.putString("lowPower", "on");
                }else{ editor.putString("lowPower", "off"); }
                editor.commit();
        ...
        geoPrecision.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (geoPrecision.isChecked()){ editor.putString("geoPrecision", "on");
                }else{ editor.putString("geoPrecision", "off"); }
                editor.commit();
        ...
        autoStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(autoStart.isChecked()){ editor.putString("autoStart", "on");
                }else{ editor.putString("autoStart", "off"); }
                editor.commit();
            }});
        ...
        emailNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(emailNotification.isChecked()){ editor.putString("emailNotification", "on");
                }else{ editor.putString("emailNotification", "off"); }
                editor.commit(); }});
        ...
        realTimeNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(realTimeNotification.isChecked()){ editor.putString("realTimeNotification", "on");
                }else{ editor.putString("realTimeNotification", "off");}
                editor.commit(); }});
        ...
        infectionNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(infectionNotification.isChecked()){ editor.putString("infectionNotification", "on");
                }else{ editor.putString("infectionNotification", "off"); }
                editor.commit(); }});
        ...
        soundNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(soundNotification.isChecked()){ editor.putString("soundNotification", "on");
                }else{ editor.putString("soundNotification", "off"); }
                editor.commit();
                }});
        ...
        advancedFilters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(advancedFilters.isChecked()){ editor.putString("advancedFilters", "on");
                }else{ editor.putString("advancedFilters", "off"); }
                editor.commit(); }});
        ...
        rotation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(rotation.isChecked()){ editor.putString("rotationSwitch", "on");
                }else{ editor.putString("rotationSwitch", "off");}
                editor.commit(); }});
        ...
        humidity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(humidity.isChecked()){ editor.putString("humiditySensor", "on");
                }else{ editor.putString("humiditySensor", "off");}
                editor.commit(); }});
        ...
        pressure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(pressure.isChecked()){ editor.putString("pressureSensor", "on");
                }else{ editor.putString("pressureSensor", "off"); }
                editor.commit(); }});
        ...
        luminosity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(luminosity.isChecked()){ editor.putString("luminositySensor", "on");
                }else{ editor.putString("luminositySensor", "off"); }
                editor.commit();}});
        ...
        dayActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(dayActivity.isChecked()){ editor.putString("dayActivity", "on");
                }else{ editor.putString("dayActivity", "off"); }
                editor.commit(); }});
        ...
        nightActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(nightActivity.isChecked()){ editor.putString("nightActivity", "on");
                }else{ editor.putString("nightActivity", "off"); }
                editor.commit(); }});
        ...
        temperature.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(temperature.isChecked()){ editor.putString("temperatureSensor", "on");
                }else{ editor.putString("temperatureSensor", "off"); }
                editor.commit(); }});
